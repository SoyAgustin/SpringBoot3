...
class MedicoRepositoryTest {
    ...
    /*El de test se va a autoinstanciar solo para pruebas, va a ser
    * el encargado de realizar las operaciones con la base de datos*/
    @Autowired
    ...
    void seleccionarMedicoConEspecialidadEnFechaEscenario1() {
        ...
        var proximoLunes10H = LocalDate.now()
                ...
                .atTime(10,0);
        /*Se va a hacer una prueba de registrar un paciente, medico en la db
        * y finalmente se registra una consulta con estos parametros.*/
